...
//////////
  ...
  bool estimateRevisitPose(const Scan2D *curScan, const std::vector<LPoint2D,Eigen::aligned_allocator<LPoint2D>> &refLps, const Pose2D &initPose, Pose2D &revisitPose);
